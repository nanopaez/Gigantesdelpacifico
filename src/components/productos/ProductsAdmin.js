...
const Producto = () => {
    ...
    const updateproductos = () => {
        ...
        fetch(config.apiURL+"productos/"+config.operatorId, requestOptions).then((response) => {
    ...
    const disable = (product) => {
        if(window.confirm("¿Está seguro/a de querer deshabilitar:\n"+product.name)){
            ...
            fetch(config.apiURL+"productos/"+product.id, requestOptionsPatch).then((response) => {
                return response.json();
            }).then((result) => {
                updateproductos();
                    ...
                    <section className="content">
                        <div className="card">
                            <div className="card-header">
                                <Link to="/productos/add" className="btn btn-success"><i className="fas fa-plus"></i> Nuevo</Link>
                            </div>
